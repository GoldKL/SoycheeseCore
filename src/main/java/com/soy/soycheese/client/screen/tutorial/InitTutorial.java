...
public class InitTutorial {
    ...
    public static TutorialTexture texture = TutorialTexture.create()
            .setTexture(new ResourceLocation(SoycheeseCore.MODID, "textures/gui/texture.png"))
            .setWidth(92)
            .setHeight(74);
    ...
    public static TutorialTip tip_crafting_table = new TutorialTip(
            new ArrayList<>(
                    List.of(
                            Component.translatable("soycheese_core.tips.crafting_table_1")
                    )
            )
    );
    ...
    public static TutorialPage CRAFTING_TABLE = ADD(
            TutorialPage.create()
                    ...
                    .setTitle(Component.translatable("soycheese_core.tips.crafting_table"))
